...
public class HttpRequest extends HttpBase<HttpRequest> {
    ...
    public HttpRequest setSSLProtocol(String protocol) {
        if (null == this.ssf) {
            try {
                ...
                logger.error("Set SSL Protocol failed", e);
            }
        }
        return this;
    }
    ...
    public HttpResponse execute(boolean isAsync) {
        ...
        try {
            ...
            logger.error("Connect host failed",e);
        }
     ...
     * 初始化网络连接
     */
    private void initConnecton() throws HttpException{
        // 初始化 connection
    ...
    private HttpResponse sendRedirectIfPosible() {
        ...
        if (this.httpConnection.getHttpURLConnection().getInstanceFollowRedirects()) {
            ...
            try {
                ...
                logger.error("Get responseCode failed", e);
            }
