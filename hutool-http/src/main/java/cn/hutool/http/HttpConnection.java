...
public class HttpConnection {
     ...
     */
    public static HttpConnection create(String urlStr, Method method) throws HttpException {
     ...
     * @return HttpConnection
     */
    public static HttpConnection create(String urlStr, Method method, int timeout) throws HttpException {
     ...
     * @return HttpConnection
     */
    public static HttpConnection create(String urlStr, Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf) throws HttpException {
     ...
     * @return HttpConnection
     */
    public static HttpConnection create(String urlStr, Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) throws HttpException {
     ...
     * @since 4.1.9
     */
    public static HttpConnection create(URL url, Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) throws HttpException {
     ...
     * @param method HTTP方法
     */
    public HttpConnection(String urlStr, Method method) throws HttpException {
     ...
     * @param timeout 超时时长
     */
    public HttpConnection(String urlStr, Method method, int timeout) throws HttpException {
     ...
     * @param proxy            代理
     */
    public HttpConnection(String urlStr, Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) throws HttpException {
     ...
     * @param proxy            代理
     */
    public HttpConnection(URL url, Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) throws HttpException {
        this.url = url;
     ...
     * @return HttpConnection
     */
    public HttpConnection initConn() throws HttpException {
        // method
        try {
